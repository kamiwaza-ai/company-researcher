  ...
  theme: {
  	extend: {
  		colors: {
  			...
  			'secondary-brand-light': 'var(--secondary-brand-light)',
  			'secondary-brand-lighter': 'var(--secondary-brand-lighter)',
  			'secondary-brand-dark': 'var(--secondary-brand-dark)',
  			'secondary-brand-darker': 'var(--secondary-brand-darker)',
  			'neutral-accent': 'var(--neutral-accent)',
  			'neutral-accent2x': 'var(--neutral-accent2x)',
  			'neutral-dark': 'var(--neutral-dark)',
  			'neutral-darker': 'var(--neutral-darker)',
  			'neutral-darkest': 'var(--neutral-darkest)',
  			'neutral-default': 'var(--neutral-default)',
  			'neutral-faint': 'var(--neutral-faint)',
  			'neutral-fainter': 'var(--neutral-fainter)',
